# -*- coding: utf-8 -*-
"""
Created on Fri Aug 10 15:25:29 2018
...
def load_checkpoint(checkpoint, D, G, D_opt=None, G_opt=None):
    ...
    if D_opt:
        D_opt.load_state_dict(checkpoint['D_optim_dict'])
    if G_opt:
        G_opt.load_state_dict(checkpoint['G_optim_dict'])
